...
public enum AppStringKey: String, CaseIterable, Sendable {
    ...
    case menuDiscoveryManualRemovalInstructions = "menu.discovery.manual_removal.instructions"
    case menuDiscoveryManualRemovalInstructionsAccessibility =
        "menu.discovery.manual_removal.instructions.accessibility"
    case menuDiscoveryManualRemovalInstructionsHint =
        "menu.discovery.manual_removal.instructions.hint"
    case menuDiscoveryManualRemovalTitle = "menu.discovery.manual_removal.title"
    case menuDiscoveryManualRemovalDetail = "menu.discovery.manual_removal.detail"
    case menuDiscoveryManualRemovalNativeWarning = "menu.discovery.manual_removal.native_warning"
    case menuDiscoveryManualRemovalNativeReady = "menu.discovery.manual_removal.native_ready"
    case menuDiscoveryManualRemovalCommand = "menu.discovery.manual_removal.command"
    case menuDiscoveryManualRemovalDiagnostics = "menu.discovery.manual_removal.diagnostics"
    case menuDiscoveryManualRemovalCopyCommand = "menu.discovery.manual_removal.copy_command"
    case menuDiscoveryManualRemovalClose = "menu.discovery.manual_removal.close"
    ...
    case updateSettingsTitle = "update.settings.title"
    case updateAutomaticChecks = "update.automatic_checks"
    case updateAutomaticChecksHint = "update.automatic_checks.hint"
    case updateAutomaticChecksDetail = "update.automatic_checks.detail"
    case updateLocalDevelopmentAutomaticDisabled = "update.local_development.automatic_disabled"
    case updateChannel = "update.channel"
    case updateChannelStable = "update.channel.stable"
    case updateChannelPreview = "update.channel.preview"
    case updateLastChecked = "update.last_checked"
    case updateSelectedVersion = "update.selected_version"
    case updateCheckNow = "update.check_now"
    case updateCheckNowHint = "update.check_now.hint"
    case updateOpenRelease = "update.open_release"
    case updateOpenReleaseHint = "update.open_release.hint"
    case updateDismissBadge = "update.dismiss_badge"
    case updateDownload = "update.download"
    case updateDownloadHint = "update.download.hint"
    case updateRevealInFinder = "update.reveal_in_finder"
    case updateRevealInFinderHint = "update.reveal_in_finder.hint"
    case updateQuitForInstall = "update.quit_for_install"
    case updateStageDownloading = "update.stage.downloading"
    case updateStageRevalidating = "update.stage.revalidating"
    case updateStageReady = "update.stage.ready"
    case updateStageFailed = "update.stage.failed"
    case updateFinderHandoffReady = "update.finder_handoff.ready"
    case updateQuitConfirmationTitle = "update.quit_confirmation.title"
    case updateQuitConfirmationDetail = "update.quit_confirmation.detail"
    case updateQuitConfirmationAction = "update.quit_confirmation.action"
    case updateQuitConfirmationCancel = "update.quit_confirmation.cancel"
    case updateAvailableBadge = "update.available_badge"
    case updateStatusNotChecked = "update.status.not_checked"
    case updateStatusCurrent = "update.status.current"
    case updateStatusNewerThanChannel = "update.status.newer_than_channel"
    case updateStatusAvailable = "update.status.available"
    case updateStatusOffline = "update.status.offline"
    case updateStatusRateLimited = "update.status.rate_limited"
    case updateStatusInvalidRelease = "update.status.invalid_release"
    case updateStatusUpdaterTooOld = "update.status.updater_too_old"
    case updateStatusUnsupportedSystem = "update.status.unsupported_system"
    case updateStatusFailed = "update.status.failed"
    case updateMenuChannel = "update.menu.channel"
    case updateMenuLastChecked = "update.menu.last_checked"
    case updateMenuStatus = "update.menu.status"
    case runtimeUpgradeTitle = "runtime_upgrade.title"
    case runtimeUpgradeInstalledVersion = "runtime_upgrade.installed_version"
    case runtimeUpgradeBundledVersion = "runtime_upgrade.bundled_version"
    case runtimeUpgradeRefresh = "runtime_upgrade.refresh"
    case runtimeUpgradeApply = "runtime_upgrade.apply"
    case runtimeUpgradeRecover = "runtime_upgrade.recover"
    case runtimeUpgradeCancel = "runtime_upgrade.cancel"
    case runtimeUpgradeStateChecking = "runtime_upgrade.state.checking"
    case runtimeUpgradeStateNotIntegrated = "runtime_upgrade.state.not_integrated"
    case runtimeUpgradeStateCurrent = "runtime_upgrade.state.current"
    case runtimeUpgradeStateAvailable = "runtime_upgrade.state.upgrade_available"
    case runtimeUpgradeStateRecoveryRequired = "runtime_upgrade.state.recovery_required"
    case runtimeUpgradeStateIncompatible = "runtime_upgrade.state.incompatible"
    case runtimeUpgradeDetailChecking = "runtime_upgrade.detail.checking"
    case runtimeUpgradeDetailNotIntegrated = "runtime_upgrade.detail.not_integrated"
    case runtimeUpgradeDetailCurrent = "runtime_upgrade.detail.current"
    case runtimeUpgradeDetailAvailable = "runtime_upgrade.detail.upgrade_available"
    case runtimeUpgradeDetailRecoveryRequired = "runtime_upgrade.detail.recovery_required"
    case runtimeUpgradeDetailIncompatible = "runtime_upgrade.detail.incompatible"
    case runtimeUpgradeFailedDetail = "runtime_upgrade.detail.failed"
    case runtimeUpgradeConfirmationTitle = "runtime_upgrade.confirmation.title"
    case runtimeUpgradeConfirmationDetail = "runtime_upgrade.confirmation.detail"
